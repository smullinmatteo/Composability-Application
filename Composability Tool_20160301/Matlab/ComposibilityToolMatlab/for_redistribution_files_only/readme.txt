...
-ComposibilityToolMatlab.dll
   -contains the generated component using MWArray API. 
-ComposibilityToolMatlabNative.dll
...
ComposibilityToolMatlab_overview.html - HTML overview documentation file for the 
...
ComposibilityToolMatlab.xml - This file contains the code comments for the 
                                        ComposibilityToolMatlab component classes and 
                                        ...
                                        documentation for the ComposibilityToolMatlab 
                                        component.
