...
namespace ComposibilityToolMatlab
{
  ...
  /// <summary>
  /// The SustainabilityEvaluation class provides a CLS compliant, MWArray interface to
  ...
  public class SustainabilityEvaluation : IDisposable
  {
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray Sustainability_Evaluation_Criteria(MWArray inputVars)
    {
    ...
    /// arguments.</returns>
    ///
    public MWArray[] Sustainability_Evaluation_Criteria(int numArgsOut, MWArray inputVars)
    {
