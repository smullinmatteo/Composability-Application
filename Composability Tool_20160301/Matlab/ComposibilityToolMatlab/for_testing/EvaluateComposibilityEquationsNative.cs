...
namespace ComposibilityToolMatlabNative
{
  ...
  public class EvaluateComposibilityEquations : IDisposable
  {
    ...
    ///
    public Object evaluateComposibilityEquations()
    {
      return mcr.EvaluateFunction("evaluateComposibilityEquations", new Object[]{});
    }
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object evaluateComposibilityEquations(Object expr)
    {
    ...
    /// arguments.</returns>
    ///
    public Object[] evaluateComposibilityEquations(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "evaluateComposibilityEquations", new Object[]{});
    }
    ...
    /// arguments.</returns>
    ///
    public Object[] evaluateComposibilityEquations(int numArgsOut, Object expr)
    {
    ...
    /// arguments</param>
    ///
    [MATLABSignature("evaluateComposibilityEquations", 1, 2, 0)]
    protected void evaluateComposibilityEquations(int numArgsOut, ref Object[] argsOut, Object[] argsIn, params Object[] varArgsIn)
    {
        mcr.EvaluateFunctionForTypeSafeCall("evaluateComposibilityEquations", numArgsOut, ref argsOut, argsIn, varArgsIn);
    }
