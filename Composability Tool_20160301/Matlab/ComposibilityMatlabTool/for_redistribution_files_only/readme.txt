...
-ComposibilityMatlabTool.dll
   -contains the generated component using MWArray API. 
-ComposibilityMatlabToolNative.dll
...
ComposibilityMatlabTool_overview.html - HTML overview documentation file for the 
...
ComposibilityMatlabTool.xml - This file contains the code comments for the 
                                        ComposibilityMatlabTool component classes and 
                                        ...
                                        documentation for the ComposibilityMatlabTool 
                                        component.
